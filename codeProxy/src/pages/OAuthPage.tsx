...
import { oauthApi } from "@/lib/http/apis/oauth";
import { vertexApi } from "@/lib/http/apis/vertex";
import type { OAuthProvider, IFlowCookieAuthResponse } from "@/lib/http/types";
...
type VertexImportResponse = Awaited<ReturnType<typeof vertexApi.importCredential>>;
