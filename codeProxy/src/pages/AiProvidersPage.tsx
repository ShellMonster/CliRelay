...
import { ampcodeApi, providersApi } from "@/lib/http/apis";
...
export function AiProvidersPage() {
  ...
  const { keyStats, statusBarCache, loadKeyStats } = useProviderStats({
    geminiKeys,
    codexConfigs,
    claudeConfigs,
    vertexConfigs,
      ...
      <div className={styles.content}>
        ...
        <div id="provider-gemini">
          <GeminiSection
            configs={geminiKeys}
            keyStats={keyStats}
            statusBarCache={statusBarCache.gemini}
            loading={loading}
        ...
        <div id="provider-codex">
          <CodexSection
            ...
            keyStats={keyStats}
            statusBarCache={statusBarCache.codex}
            loading={loading}
            disableControls={disableControls}
            isSwitching={isSwitching}
        ...
        <div id="provider-claude">
          <ClaudeSection
            ...
            keyStats={keyStats}
            statusBarCache={statusBarCache.claude}
            loading={loading}
            disableControls={disableControls}
            isSwitching={isSwitching}
        ...
        <div id="provider-vertex">
          <VertexSection
            ...
            keyStats={keyStats}
            statusBarCache={statusBarCache.vertex}
            loading={loading}
            disableControls={disableControls}
            isSwitching={isSwitching}
        ...
        <div id="provider-openai">
          <OpenAISection
            ...
            keyStats={keyStats}
            statusBarCache={statusBarCache.openai}
            loading={loading}
            disableControls={disableControls}
            isSwitching={isSwitching}
            resolvedTheme={resolvedTheme}
