...
const extractSectionValue = (config: Config | null, section?: RawConfigSection) => {
  ...
  switch (section) {
    ...
    case "usage-log-content-enabled":
      return config.usageLogContentEnabled;
    case "request-log":
    ...
    case "codex-compat-api-key":
      return config.codexCompatApiKeys;
    case "copilot-compat-api-key":
      return config.copilotCompatApiKeys;
    case "claude-api-key":
    ...
    set((state) => {
      ...
      switch (section) {
        ...
        case "usage-statistics-enabled":
          ...
          break;
        case "usage-log-content-enabled":
          nextConfig.usageLogContentEnabled = value as Config["usageLogContentEnabled"];
          break;
        case "request-log":
        ...
        case "codex-api-key":
          ...
          break;
        case "codex-compat-api-key":
          nextConfig.codexCompatApiKeys = value as Config["codexCompatApiKeys"];
          break;
        case "copilot-compat-api-key":
          nextConfig.copilotCompatApiKeys = value as Config["copilotCompatApiKeys"];
          break;
        case "claude-api-key":
