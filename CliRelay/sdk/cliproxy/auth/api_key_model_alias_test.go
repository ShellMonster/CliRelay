...
func TestAPIKeyModelAlias_MultipleProviders(t *testing.T) {
	cfg := &internalconfig.Config{
		...
		CodexCompatKey: []internalconfig.CodexKey{{
			APIKey: "codex-compat-key",
			Models: []internalconfig.CodexModel{{Name: "gpt-5.4", Alias: "g54"}},
		}},
	}
	...
	_, _ = mgr.Register(ctx, &Auth{ID: "codex-compat-auth", Provider: "codex-compat", Attributes: map[string]string{"api_key": "codex-compat-key"}})
