...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	cfg.UsageLogContentEnabled = true
...
func (cfg *Config) SanitizeOpenAICompatibility() {
	...
	for i := range cfg.OpenAICompatibility {
		...
		for j := range e.APIKeyEntries {
			...
			e.APIKeyEntries[j].Headers = NormalizeHeaders(e.APIKeyEntries[j].Headers)
		}
		if e.BaseURL == "" {
...
func SaveConfigPreserveComments(configFile string, cfg *Config) error {
	...
	pruneMappingToGeneratedKeys(original.Content[0], generated.Content[0], "api-keys")
	pruneMappingToGeneratedKeys(original.Content[0], generated.Content[0], "api-key-entries")
