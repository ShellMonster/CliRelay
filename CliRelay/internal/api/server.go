...
import (
	...
	"github.com/router-for-me/CLIProxyAPI/v6/internal/modelsync"
...
type Server struct {
	...
	modelSyncService   *modelsync.Service
}
...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	s.modelSyncService = modelsync.New(s.mgmt.ConfigManager(), 30*time.Minute)
	s.modelSyncService.Start(context.Background())
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/monitor/hourly", s.mgmt.GetMonitorHourlySeries)
		mgmt.GET("/monitor/channel-stats", s.mgmt.GetMonitorChannelStats)
		...
		mgmt.GET("/routing/user-agent-options", s.mgmt.GetUserAgentRoutingOptions)
		...
		mgmt.GET("/codex-compat-api-key", s.mgmt.GetCodexCompatKeys)
		mgmt.PUT("/codex-compat-api-key", s.mgmt.PutCodexCompatKeys)
